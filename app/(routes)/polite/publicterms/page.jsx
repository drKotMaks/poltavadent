...
const Publicterms = () => {
 ...
 return (
    ...
    <section>
        ...
        <p>Наш вебсайт може містити посилання на сторонні вебсайти, за зміст і політику яких {setting.title} не несе відповідальності. Ми рекомендуємо ознайомитися з умовами використання цих сайтів перед переходом за посиланням.</p>
    </section>
