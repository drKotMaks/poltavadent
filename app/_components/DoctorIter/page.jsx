...
export default function DoctorIter () {

    return (
        <article className="flex flex-col relative rounded-lg shadow-2xl bg-white dark:bg-neutral-800">
                        <div className="relative w-full min-h-[18rem] min-w-[18rem] pt-[56.25%] overflow-hidden rounded-lg text-white">
                            <Image className="absolute top-0 w-full h-full object-cover" src="/photo_2024-05-13_09-54-37.jpg" loading="lazy" alt=""
                            width={200} 
                            height={300} 
                            />
