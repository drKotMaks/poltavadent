...
const LinkButton = ({text, href}) => {
  return (
    <Link href={href} className="relative group inline-block w-full xs:w-auto py-4 px-6 text-orange-900 hover:text-white font-semibold bg-orange-50 rounded-md overflow-hidden transition duration-500" href="#">
